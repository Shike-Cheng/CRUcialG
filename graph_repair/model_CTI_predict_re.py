...
class GraphFlowModel(nn.Module):
    ...
    def generate(self, cur_node_data, cur_adj_data, free_id, free_node, original_graph, temperature=0.75, mute=False, max_atoms=100, cnt=None):  # 使用flow生成molecule
        """
        ...
        with torch.no_grad():  # 所有计算得出的tensor的requires_grad都自动设置为False。
            ...
            increase_edges = []
            i = free_id
            # for i in range(cut_node+1, max_atoms):
            # print("开始第{}个节点的预测".format(i))
