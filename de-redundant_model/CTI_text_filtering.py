...
if __name__ == '__main__':
    ...
    config = BertConfig.from_pretrained(r"./models/config.json")
    ...
    for doc in file_doc_list:
        file_newdoc_list.append(os.path.join(new_start_dir, doc.split('\\')[-1]))
    ...
    for index, text in enumerate(file_doc_list):
        ...
        with open(file_newdoc_list[index], mode='w', encoding="ISO-8859-1") as f2:
            f2.write(new_text)
